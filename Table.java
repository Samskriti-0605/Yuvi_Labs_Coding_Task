...
public class Main {
    static void Yuvi_Labs(int[][] even, int size, int highlight) {
        System.out.print("  ");
        ...
        for (int row = 0; row < size; row++) {
            ...
            for (int col = 0; col < size; col++) {
                if (highlight != -1 && even[row][col] == highlight) {
                    System.out.printf("|[%2d]", even[row][col]);
                } else {
                    System.out.printf("| %2d ", even[row][col]);
                }
            }
    ...
    public static void main(String[] args) {
       ...
       Yuvi_Labs(array, size, -1);
        ...
        Yuvi_Labs(array, size, numberToHighlight);
